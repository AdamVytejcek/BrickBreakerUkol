...
namespace BrickBreakerUkol
{
    public partial class Form1 : Form
    {
        ...
        {
            ///dá barvy kuličce a udělá ze čtverečku kolečko
            e.Graphics.FillEllipse(Brushes.Aqua, new Rectangle(new Point(0, 0), ball.Size));
        }
        ...
        private void mainGameTimerEvent(object sender, EventArgs e)
        {
            ...
            {
                gameOver("Vyhrál jsi!! " +
                          "Zmáčkni Enter a hraj znovu");
            }

            if(ball.Top > 580)
            {
                gameOver("Prohrál jsi!! " +
                           "Zmáčkni Enter a zkus to znovu");
            }
